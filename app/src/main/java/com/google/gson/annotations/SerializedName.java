 ...
 *
 *   public SomeClassWithFields(String a, String letter) {
 *     this.someField = a;
 *     this.someOtherField = letter;
 *   }
 * }
 * </pre>
 *
 ...
 * <pre>
 * SomeClassWithFields objectToSerialize = new SomeClassWithFields("a", "letter");
 * Gson gson = new Gson();
 * String jsonRepresentation = gson.toJson(objectToSerialize);
 * System.out.println(jsonRepresentation);
 *
 * ===== OUTPUT =====
 * {"name":"a","someOtherField":"letter"}
 * </pre>
 *
